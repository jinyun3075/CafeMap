            ...
            for (const marker of data) {
                ...
                for (const i in marker.img) {
                    if (i == 0) {
                        ...
                        slide += `<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="${i}" class="active" aria-current="true" aria-label="Slide ${i + 1}"></button>`;
                    } else {
        ...
        li[i].onclick = () => {
            ...
            for (const i2 in json[i].img) {
                if (i2 == 0) {
                    ...
                    slide += `<button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="${i2}" class="active" aria-current="true" aria-label="Slide ${i2 + 1}"></button>`;
                } else {
                    img += 
